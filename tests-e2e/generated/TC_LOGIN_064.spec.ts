/**
 * Assembled from a Playwright Codegen recording of TC_LOGIN_064.
 *
...
test.describe('Login Test Cases', () => {
  test('TC_LOGIN_064 - Close — #tc_summary_637609 contains "After selecting Different date in calendar of line chart it is showing current date and time and also displaying daily line instead of hourly"', async ({ page, loginPage, projectsPage, bugasuraCredentials, step }) => {
    requireCredentials(bugasuraCredentials);

    await trace({
      testCaseId: 'TC_LOGIN_064',
      module: '',
      scenario: 'Close — #tc_summary_637609 contains "After selecting Different date in calendar of line chart it is showing current date and time and also displaying daily line instead of hourly"',
