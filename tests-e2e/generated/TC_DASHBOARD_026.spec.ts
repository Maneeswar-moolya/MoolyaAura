/**
 * Assembled from a Playwright Codegen recording of TC_DASHBOARD_026.
 *
...
test.describe('DashBoard', () => {
  test('TC_DASHBOARD_026 - #tr_1749552 > .tabulator-cell.tabulator-cell--checkbox > .rounded-checkbox-cont > .rounded-checkbox-ui — 1749558 is ticked', async ({ page, loginPage, projectsPage, bugasuraCredentials, step, issuesPage }) => {
    requireCredentials(bugasuraCredentials);

    await trace({
      testCaseId: 'TC_DASHBOARD_026',
      module: '',
      scenario: '#tr_1749552 > .tabulator-cell.tabulator-cell--checkbox > .rounded-checkbox-cont > .rounded-checkbox-ui — 1749558 is ticked',
