/**
 * Assembled from a Playwright Codegen recording of TC_DASHBOARD_002.
 *
...
test.describe('Login', () => {
  test('TC_DASHBOARD_002 - Notifications — #ap_notifications_panel contains "Notification Preferences"', async ({ page, loginPage, bugasuraCredentials, step }) => {
    requireCredentials(bugasuraCredentials);

    await trace({
      testCaseId: 'TC_DASHBOARD_002',
      module: 'Login',
      scenario: 'Notifications — #ap_notifications_panel contains "Notification Preferences"',
