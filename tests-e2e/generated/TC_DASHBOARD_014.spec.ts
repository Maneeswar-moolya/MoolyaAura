/**
 * Assembled from a Playwright Codegen recording of TC_DASHBOARD_014.
 *
 ...
 *
 * 8 step(s) use the recorded locator directly, because no Page
...
test.describe('DashBoard', () => {
  test('TC_DASHBOARD_014 - Config Line Chart: Unable to — #all_apps contains "Faclon labs"', async ({ page, loginPage, projectsPage, bugasuraCredentials, step }) => {
    requireCredentials(bugasuraCredentials);

    await trace({
      testCaseId: 'TC_DASHBOARD_014',
      module: 'DashBoard',
