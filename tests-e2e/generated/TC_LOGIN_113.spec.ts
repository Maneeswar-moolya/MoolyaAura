/**
 * Assembled from a Playwright Codegen recording of TC_LOGIN_113.
 *
...
test.describe('Login Test Cases', () => {
  test('TC_LOGIN_113 - #tr_637446 > .tabulator-cell.tabulator-cell--checkbox > .rounded-checkbox-cont > .rounded-checkbox-ui — 637446 is ticked', async ({ page, loginPage, projectsPage, bugasuraCredentials, step, issuesPage }) => {
    requireCredentials(bugasuraCredentials);

    await trace({
      testCaseId: 'TC_LOGIN_113',
      module: '',
      scenario: '#tr_637446 > .tabulator-cell.tabulator-cell--checkbox > .rounded-checkbox-cont > .rounded-checkbox-ui — 637446 is ticked',
    ...
    await step('click #tr_637609 > .tabulator-cell.tabulator-cell--checkbox', async () => {
      await (page.locator(".tabulator-row").filter({ hasText: "After selecting Different date in calendar of line chart it" }).locator(".tabulator-cell--checkbox")).click();
    });
