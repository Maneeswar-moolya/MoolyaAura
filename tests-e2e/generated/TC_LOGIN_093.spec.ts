/**
 * Assembled from a Playwright Codegen recording of TC_LOGIN_093.
 *
...
test.describe('Login Test Cases', () => {
  test('TC_LOGIN_093 - Faclon labs — 639978 is not ticked', async ({ page, loginPage, projectsPage, bugasuraCredentials, step }) => {
    requireCredentials(bugasuraCredentials);

    await trace({
      testCaseId: 'TC_LOGIN_093',
      module: '',
      scenario: 'Faclon labs — 639978 is not ticked',
