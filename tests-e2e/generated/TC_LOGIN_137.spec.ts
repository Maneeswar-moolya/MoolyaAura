/**
 * Assembled from a Playwright Codegen recording of TC_LOGIN_137.
 *
...
test.describe('Login Test Cases', () => {
  test('TC_LOGIN_137 - Verify panel in the Notifications panel', async ({ page, loginPage, projectsPage, workspacePage, bugasuraCredentials, step, notificationsPanel }) => {
    requireCredentials(bugasuraCredentials);

    await trace({
      testCaseId: 'TC_LOGIN_137',
      module: '',
      scenario: 'Verify panel in the Notifications panel',
